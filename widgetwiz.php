...
<?php
if ($_GET['url'] && 'http://' != $_GET['url'] && (0 == $_GET['depth'] || $_GET['depth'] > 0) && $_GET['height'] && $_GET['width']) {
...
<table>
<tr>
<td style="width: 8em;">OPML URL:</td>
<td><input size="40" name="url" tabindex="1" type="text" value="<?php echo $_GET['url'] ? $_GET['url'] : 'http://' ?>"></td>
</tr>
<tr>
<td style="width: 8em;">Initial Depth:</td>
<td><input size="4" name="depth" tabindex="2" type="text" value="<?php echo $_GET['depth'] ? $_GET['depth'] : '0' ?>"></td>
</tr>
<tr>
<td style="width: 8em;">Widget Height:</td>
<td><input size="4" name="height" tabindex="3" type="text" value="<?php echo $_GET['height'] ? $_GET['height'] : '400' ?>"></td>
</tr>
<tr>
<td style="width: 8em;">Widget Width:</td>
<td><input size="4" name="width" tabindex="4" type="text" value="<?php echo $_GET['width'] ? $_GET['width'] : '200' ?>"></td>
</tr>
<tr>
<td colspan="2"><input style="border: 1px outset #ccc; padding: 1px; background: #ddd;" type="submit" name="submit" tabindex="5" value="Generate Widget"></td>
</tr>
</table>
</form>
</body>
